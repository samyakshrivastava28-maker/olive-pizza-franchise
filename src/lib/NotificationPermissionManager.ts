...
export class NotificationPermissionManager {
  ...
  static async checkPermission(): Promise<NotificationPermissionInfo> {
    ...
    if (platform === 'android' || platform === 'ios') {
      try {
        ...
        console.warn('[Franchise NotificationPermission] Native check error:', err);
      }
    }
  ...
  /**
   * Request native permission when appropriate.
   */
  static async requestPermission(): Promise<NotificationPermissionInfo> {
    ...
    if (platform === 'android' || platform === 'ios') {
      try {
        ...
        console.warn('[Franchise NotificationPermission] Native request error:', err);
      }
    }
  ...
  static async openSettingsInstructions(): Promise<string> {
    ...
    if (platform === 'android' || platform === 'ios') {
      ...
      return 'Please open your phone Settings > Apps > Olive Pizza Franchise > Notifications and switch to Allow.';
    }
